...
public class SpecVersionHandler {
    ...
    public SpecDocument saveDocument(String specId, String docType, SpecDocumentRequest request) {
        ...
        if (existing != null) {
            ...
            createVersionSnapshot(specId, docType, request.getContent(),
                    newVersion, request.getChangeSummary());

            log.info("更新Spec文档: specId={}, docType={}, version={}", specId, docType, newVersion);
            return existing;
        }
        ...
        // 创建初始版本快照
        createVersionSnapshot(specId, docType, request.getContent(),
                1, request.getChangeSummary());

        log.info("创建Spec文档: specId={}, docType={}", specId, docType);
        return document;
    }
    ...
    private void createVersionSnapshot(String specId, String docType,
                                       String content, int versionNumber, String changeSummary) {
