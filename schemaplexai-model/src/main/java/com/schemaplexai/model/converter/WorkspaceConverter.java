...
public interface WorkspaceConverter {
    ...
    @Mapping(target = "accessMode", ignore = true)
    @Mapping(target = "writeCapability", ignore = true)
    @Mapping(target = "browseCapability", ignore = true)
    @Mapping(target = "downloadCapability", ignore = true)
